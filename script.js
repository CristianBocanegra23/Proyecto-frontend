...
// Función para avanzar a la siguiente imagen (BMW)
const nextImage = () => {
...
// Función para retroceder a la imagen anterior (BMW)
const previewImage = () => {
    const image = document.getElementById('imgIdbmw');
...
const nextImage2 = () => {
    ...
    if (index < arrayObjects2.length - 1) {
        ...
        image.src = arrayObjects2[0].imagen;
    }
};
...
const previewImage2 = () => {
    ...
    if (index > 0) {
        ...
        image.src = imageArray2[imageArray3.length - 1];
    }
};
...
// Función para avanzar a la siguiente imagen (Rolls-Royce)
const nextImage3 = () => {
    ...
    if (index < arrayObjects3.length - 1) {
        ...
        image.src = arrayObjects3[0].imagen;
    }
};
// Función para retroceder a la imagen anterior (Rolls-Royce)
const previewImage3 = () => {
    const image = document.getElementById('imgIdrollsroyce');
    const index = imageArray3.indexOf(image.src);
    if (index > 0) {
        image.src = imageArray3[index - 1];
    } else {
        image.src = imageArray3[imageArray3.length - 1];
    }
};
